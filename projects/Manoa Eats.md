...
# Take Aways
This was my first big project working with a team. It is difficult working with a lot of different personalities and work ethics. I feel our biggest challenge we needed to over come was figuring out a time we were all free. In the end we found it easier to message each other the day of to figure out what a good time would be to meet. We were having small meetings on the weekends through discord to go over our weekly tasks and we would be meeting before class to code our application. Thankfully Discord was invented, it made things a lot easier to have messaging and video calls all in one place. 

It is also so important to always communicate and plan with everyone so two people are not working on the same tasks. We also noticed there were points where there were certain implementations that are unable to happen unless someone finishes their part. So, we needed to make sure we stayed on top of everything, were constantly giving updates about our progress, and setting deadlines. Using the projects tab in Github helped tremendously because we were able to see the set of tasks that needed to be finished and once a task was completed it would no longer be open.
